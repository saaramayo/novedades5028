...
export default function BuscadorAsignaciones() {
    ...
    function handleSearch(term: string) {
        ...
        startTransition(() => {
            router.push(`/dashboard/distribucion?${params.toString()}`);
        });
    }
    ...
    return (
        <div className="relative">
            <input
                type="text"
                placeholder="🔍 Buscar por Apellido de Docente, Materia o Curso..."
