import { getNovedadesDelDia, getNovedadesDeManiana } from "@/actions/dashboard";
...
export default async function DashboardPage() {
    ...
    const data2 = await getNovedadesDeManiana();
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="space-y-6">
                ...
                <p>MAÑANA</p>
                <div className="grid grid-cols-1 gap-6">
                    {data2.turnos.map((turno: any) => {
                        const licenciasDelTurno = data2.licencias.filter(
                            (lic: any) => lic.id_turno === turno.id_turno
                        );
